...
# Set the precision high enough for long messages
getcontext().prec = 50

# Function to calculate probabilities and ranges
...
def arithmetic_encode(message):
    ...
    return (low + high) / 2  # Return the final value (code)

# Function to decode the encoded value
...
def main():
    ...
    # Save the encoded value to a file
